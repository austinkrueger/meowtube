defmodule MeowtubeWeb.VideoController do
  use MeowtubeWeb, :controller
  use Rummage.Phoenix.Controller

  alias Meowtube.{Multimedia, Repo}
  alias Meowtube.Multimedia.{YoutubeData, Video}
  ...
  defp check_video_owner(conn, _params) do
    ...
    video = Meowtube.Repo.get(Video, video_id)
